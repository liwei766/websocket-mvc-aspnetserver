select * from UserVersions order by id desc;
...
select * from WorkScheduleMasters where Version=1;
...
select * from WorkScheduleStatuses;
...
select count(*) from WorkStatusHistories;

update WorkStatusHistories set StartDate=DATEADD(DAY, -1, StartDate);
select distinct version from WorkStatusHistories;

update WorkStatusHistories set version='10088' where Version='8';